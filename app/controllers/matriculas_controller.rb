...
class MatriculasController < ApplicationController
  active_scaffold :matricula do |conf|
    ...
    conf.columns[:inativo_ate].label = "Não gerar falta até"
    ...
    conf.columns = [:pessoa, :vip, :data_matricula, :data_inicio, :inativo_ate, :data_fim, :motivo_da_interrupcao, :numero_de_aulas_previstas, :objetivo, :horario_de_aula]
